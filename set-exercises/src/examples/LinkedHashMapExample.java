...
public class LinkedHashMapExample {
		...
		public static void main(String[] args) {
			...
			acoesEmpresasHash.put("Apple", new Double(91.98));
			...
			LinkedHashMap<String, Double> acoesEmpresasLinked = new LinkedHashMap<>();
			acoesEmpresasLinked.put("Apple", new Double(91.98));
